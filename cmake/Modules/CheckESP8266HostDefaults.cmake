...
if("${ARDUINO_USER}" STREQUAL "")
    ...
    elseif(EXISTS "${ARDUINO_HOME}/portable")
        set(ARDUINO_USER "${ARDUINO_HOME}/portable")
    else()
...
if(EXISTS "${ARDUINO_USER}/preferences.txt")
    ...
    if(NOT "${SKETCHBOOK_LINE}" STREQUAL "")
        ...
        if ("${SKETCHBOOK_PATH}" STREQUAL "sketchbook")
            set(SKETCHBOOK_PATH "${ARDUINO_USER}/sketchbook")
        endif()
