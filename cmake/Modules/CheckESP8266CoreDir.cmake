if("${ARDUINO_ESP8266_DIR}" STREQUAL "" AND NOT "$ENV{ARDUINO_ESP8266_DIR}" STREQUAL "")
    ...
    if("${ARDUINO_ESP8266_DIR}" STREQUAL "" AND NOT "${ARDUINO_USER}" STREQUAL "")
        if(EXISTS "${ARDUINO_USER}/packages/esp8266/hardware/esp8266/2.5.2/cores/esp8266")
            set(ARDUINO_ESP8266_DIR "${ARDUINO_USER}/packages/esp8266/hardware/esp8266/2.5.2" CACHE PATH "Path to the directory containing ESP8266 core")
        endif()
    endif()
